...
import { LayoutDashboard, Users, Network, BookOpen, FileQuestion, Award, FileBarChart, FileText, Settings, Upload } from 'lucide-react';
...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 z-20 h-screen w-64 bg-white dark:bg-gray-900 border-r">
      <div className="flex h-full flex-col">
        <div className="p-6 border-b">
          <h1 className="text-xl font-bold text-primary">Ikonex Academy</h1>
          <p className="text-xs text-gray-500 dark:text-gray-400">Academic Management</p>
        </div>
